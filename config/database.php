    ...
    */
    ...
    'connections' => [
        ...
        'bk_api_db' => [
            ...
            'database' => env('BK_API_DB_DATABASE', env('DB_DATABASE', database_path('database.sqlite'))),
        ...
        'bk_db' => [
            ...
            'host' => env('PGHOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('PGPORT', env('DB_PORT', '5432')),
            'database' => env('BK_DB_DATABASE', env('DB_DATABASE', database_path('database.sqlite'))),
            'username' => env('PGUSER', env('DB_USERNAME', 'root')),
            'password' => env('PGPASSWORD', env('DB_PASSWORD', '')),
            'charset' => 'utf8',
            'prefix' => '',
